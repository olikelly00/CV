...
|-------------------|----------------------------------------------------------|-------------------------------------------|---------|-------|
| [**Cassandra**](https://github.com/olikelly00/cassandra)    | AI-powered tarot card reading web app                    | <img height="30" width="30" src="https://abrudz.github.io/logos/Go.svg">, Gin (Backend); SvelteKit, HTML/CSS (Frontend), Render (Deployment) | Go Testing Framework | [Click to launch the web app](https://cassandratarot.onrender.com/) |
